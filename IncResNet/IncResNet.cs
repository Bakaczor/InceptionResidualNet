...
namespace IncResNet {
    ...
    public class IncResNet : Module<Tensor, Tensor> {
        ...
        public static IncResNet IncResNetv1(int resultSize, Device? device = null) {
            return new IncResNet("IncResNetv1", new int[] { 4, 8, 4 }, resultSize, device);
        }
